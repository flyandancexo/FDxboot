:: ####################################################################################
:: Flyandance C/C++ Compile and Run Batch Program 1.32
...
:BEGIN
title Flyandance C/C++ Compile and Run Batch Program 1.32
echo ===============================================================
echo   Flyandance C/C++ Compile and Run Batch Program 1.32:
echo ===============================================================
...
echo ---------------------------------------------------------------
if %AUTOrun% EQU yes ( GOTO SKIP_OUT )
...
if %AUTOrun% EQU yes ( GOTO RUN ) else (
GOTO PreEND
)
